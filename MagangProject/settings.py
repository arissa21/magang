"""
Django settings for MagangProject project.
...
SECRET_KEY = 'django-insecure-#@#u$+i-t_y1rc-luzjqv(94+qu3*643j!f18o876b+rt)w93l'
...
ROOT_URLCONF = 'MagangProject.urls'
...
WSGI_APPLICATION = 'MagangProject.wsgi.application'
